...
class QAbstractPrintDialog(QtWidgets.QDialog):
    ...
    def setOptionTabs(
        self, tabs: typing.Iterable[QtWidgets.QWidget]
    ) -> None: ...
...
class QPrintDialog(QAbstractPrintDialog):
    ...
    def setOptions(
        self, options: QAbstractPrintDialog.PrintDialogOptions
    ) -> None: ...
    def testOption(
        self, option: QAbstractPrintDialog.PrintDialogOptions
    ) -> bool: ...
    def setOption(
        self, option: QAbstractPrintDialog.PrintDialogOptions, on: bool = ...
    ) -> None: ...
    def done(self, result: int) -> None: ...
    def exec(self) -> int: ...
...
class QPrintEngine(PyQt6.sip.simplewrapper):
    class PrintEnginePropertyKey(enum.Enum):
        ...
        PPK_SupportedResolutions = (
            ...
        )  # type: QPrintEngine.PrintEnginePropertyKey
...
class QPrintPreviewWidget(QtWidgets.QWidget):
    ...
    def setZoomMode(
        self, zoomMode: "QPrintPreviewWidget.ZoomMode"
    ) -> None: ...
    def setViewMode(
        self, viewMode: "QPrintPreviewWidget.ViewMode"
    ) -> None: ...
    def setOrientation(
