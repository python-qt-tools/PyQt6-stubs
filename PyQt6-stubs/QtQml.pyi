...
class QJSEngine(QtCore.QObject):
    ...
    def setObjectOwnership(
        a0: QtCore.QObject, a1: "QJSEngine.ObjectOwnership"
    ) -> None: ...
    ...
    def installExtensions(
        self,
        extensions: "QJSEngine.Extensions",
        object: typing.Union[
...
class QQmlEngine(QJSEngine):
    ...
    def removeUrlInterceptor(
        self, urlInterceptor: QQmlAbstractUrlInterceptor
    ) -> None: ...
...
class QQmlApplicationEngine(QQmlEngine):
    ...
    def setExtraFileSelectors(
        self, extraFileSelectors: typing.Iterable[str]
    ) -> None: ...
    def loadData(
        self, data: QtCore.QByteArray, url: QtCore.QUrl = ...
    ) -> None: ...
    @typing.overload
...
class QQmlImageProviderBase(QtCore.QObject):
    class Flags(enum.Flag):
        ForceAsynchronousImageLoading = (
            ...
        )  # type: QQmlImageProviderBase.Flags
...
class QQmlProperty(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, a0: QtCore.QObject, a1: str, a2: QQmlContext
    ) -> None: ...
    @typing.overload
    def __init__(
        self, a0: QtCore.QObject, a1: str, a2: QQmlEngine
    ) -> None: ...
    @typing.overload
    ...
    def connectNotifySignal(
        self, dest: QtCore.QObject, method: int
    ) -> bool: ...
    ...
    @staticmethod
    def write(
        a0: QtCore.QObject, a1: str, a2: typing.Any, a3: QQmlContext
    ) -> bool: ...
    @typing.overload
    @staticmethod
    def write(
        a0: QtCore.QObject, a1: str, a2: typing.Any, a3: QQmlEngine
    ) -> bool: ...
    @typing.overload
...
def qmlTypeId(
    uri: str, versionMajor: int, versionMinor: int, qmlName: str
) -> int: ...
@typing.overload
def qmlRegisterType(
    url: QtCore.QUrl,
...
def qmlRegisterModule(
    uri: str, versionMajor: int, versionMinor: int
) -> None: ...
