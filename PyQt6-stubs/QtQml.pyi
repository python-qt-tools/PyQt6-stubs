...
class QJSEngine(QtCore.QObject):
    ...
    def installExtensions(
        ...
        object: typing.Union["QJSValue", "QJSValue.SpecialValue", bool, int, float, str] = ...,
    ) -> None: ...
...
class QJSValue(PyQt6.sip.simplewrapper):
    ...
    def callAsConstructor(
        self,
        args: typing.Iterable[typing.Union["QJSValue", "QJSValue.SpecialValue", bool, int, float, str]] = ...,
    ) -> "QJSValue": ...
    def callWithInstance(
        self,
        instance: typing.Union["QJSValue", "QJSValue.SpecialValue", bool, int, float, str],
        args: typing.Iterable[typing.Union["QJSValue", "QJSValue.SpecialValue", bool, int, float, str]] = ...,
    ) -> "QJSValue": ...
    def call(
        self,
    ...
    def setPrototype(
        self,
        prototype: typing.Union["QJSValue", "QJSValue.SpecialValue", bool, int, float, str],
    ) -> None: ...
