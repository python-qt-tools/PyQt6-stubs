...
class QOpenGLBuffer(PyQt6.sip.simplewrapper):
    ...
    def mapRange(
        self, offset: int, count: int, access: "QOpenGLBuffer.RangeAccessFlags"
    ) -> PyQt6.sip.voidptr: ...
    def unmap(self) -> bool: ...
    ...
    def write(
        self, offset: int, data: PyQt6.sip.voidptr, count: int
    ) -> None: ...
    def read(
        self, offset: int, data: PyQt6.sip.voidptr, count: int
    ) -> bool: ...
...
class QOpenGLShaderProgram(QtCore.QObject):
    ...
    def addCacheableShaderFromSourceFile(
        self, type: QOpenGLShader.ShaderType, fileName: str
    ) -> bool: ...
    @typing.overload
    def addCacheableShaderFromSourceCode(
        self, type: QOpenGLShader.ShaderType, source: QtCore.QByteArray
    ) -> bool: ...
    @typing.overload
    def addCacheableShaderFromSourceCode(
        self, type: QOpenGLShader.ShaderType, source: str
    ) -> bool: ...
    def create(self) -> bool: ...
    ...
    def bindAttributeLocation(
        self, name: QtCore.QByteArray, location: int
    ) -> None: ...
    @typing.overload
...
class QOpenGLTexture(PyQt6.sip.simplewrapper):
    ...
    class TextureFormat(enum.Enum):
        ...
        RGB8_PunchThrough_Alpha1_ETC2 = (
            ...
        )  # type: QOpenGLTexture.TextureFormat
    ...
    class BindingTarget(enum.Enum):
        ...
        BindingTarget2DMultisampleArray = (
            ...
        )  # type: QOpenGLTexture.BindingTarget
...
class QOpenGLFunctions_2_0(QAbstractOpenGLFunctions):
    ...
    def glGetBooleanv(
        self, pname: int
    ) -> typing.Union[bool, typing.Tuple[bool, ...]]: ...
    def glGetDoublev(
        self, pname: int
    ) -> typing.Union[float, typing.Tuple[float, ...]]: ...
