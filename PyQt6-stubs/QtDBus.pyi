...
class QDBusAbstractInterface(QtCore.QObject):
    ...
    @typing.overload
    def call(
        self, mode: "QDBus.CallMode", method: str, *a2
    ) -> "QDBusMessage": ...
...
class QDBusConnection(PyQt6.sip.simplewrapper):
    class ConnectionCapabilities(enum.Flag):
        UnixFileDescriptorPassing = (
            ...
        )  # type: QDBusConnection.ConnectionCapabilities
    ...
    class RegisterOptions(enum.Flag):
        ...
        ExportScriptableProperties = (
            ...
        )  # type: QDBusConnection.RegisterOptions
    ...
    def registerObject(
        ...
        options: "QDBusConnection.RegisterOptions" = ...,
    ) -> bool: ...
    @typing.overload
    def registerObject(
        self,
...
class QDBusMessage(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def createError(
        type: QDBusError.ErrorType, msg: str
    ) -> "QDBusMessage": ...
    @staticmethod
    ...
    @staticmethod
    def createSignal(
        path: str, interface: str, name: str
    ) -> "QDBusMessage": ...
