...
class QNetworkCacheMetaData(PyQt6.sip.simplewrapper):
    ...
    def attributes(
        self,
    ) -> typing.Dict["QNetworkRequest.Attribute", typing.Any]: ...
    ...
    def setRawHeaders(
        ...
        headers: typing.Iterable[
            typing.Tuple[QtCore.QByteArray, QtCore.QByteArray]
        ],
    ) -> None: ...
    def rawHeaders(
        self,
...
class QAbstractSocket(QtCore.QIODevice):
    ...
    def bind(
        ...
        port: int = ...,
        mode: "QAbstractSocket.BindMode" = ...,
    ) -> bool: ...
    @typing.overload
    def bind(
        self, port: int = ..., mode: "QAbstractSocket.BindMode" = ...
    ) -> bool: ...
    def setPauseMode(
        self, pauseMode: "QAbstractSocket.PauseModes"
    ) -> None: ...
    ...
    def setSocketDescriptor(
        ...
        mode: QtCore.QIODeviceBase.OpenMode = ...,
    ) -> bool: ...
    def abort(self) -> None: ...
...
class QHostAddress(PyQt6.sip.simplewrapper):
    ...
    def isEqual(
        self,
        address: typing.Union["QHostAddress", "QHostAddress.SpecialAddress"],
        mode: "QHostAddress.ConversionMode" = ...,
    ) -> bool: ...
...
class QHstsPolicy(PyQt6.sip.simplewrapper):
    ...
    def host(
        self, options: QtCore.QUrl.ComponentFormattingOptions = ...
    ) -> str: ...
    def setHost(
        self, host: str, mode: QtCore.QUrl.ParsingMode = ...
    ) -> None: ...
...
class QLocalServer(QtCore.QObject):
    ...
    def setSocketOptions(
        self, options: "QLocalServer.SocketOptions"
    ) -> None: ...
...
class QLocalSocket(QtCore.QIODevice):
    ...
    class LocalSocketError(enum.Enum):
        ...
        UnsupportedSocketOperationError = (
            ...
        )  # type: QLocalSocket.LocalSocketError
    ...
    @typing.overload
    def connectToServer(
        self, name: str, mode: QtCore.QIODeviceBase.OpenMode = ...
    ) -> None: ...
    @typing.overload
    def connectToServer(
        self, mode: QtCore.QIODeviceBase.OpenMode = ...
    ) -> None: ...
...
class QNetworkCookie(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def parseCookies(
        cookieString: QtCore.QByteArray,
...
class QNetworkCookieJar(QtCore.QObject):
    ...
    def setAllCookies(
        self, cookieList: typing.Iterable[QNetworkCookie]
    ) -> None: ...
...
class QNetworkAddressEntry(PyQt6.sip.simplewrapper):
    class DnsEligibilityStatus(enum.Enum):
        DnsEligibilityUnknown = (
            ...
        )  # type: QNetworkAddressEntry.DnsEligibilityStatus
    ...
    def setBroadcast(
        self,
        newBroadcast: typing.Union[QHostAddress, QHostAddress.SpecialAddress],
    ) -> None: ...
    def broadcast(self) -> QHostAddress: ...
    def setNetmask(
        self,
        newNetmask: typing.Union[QHostAddress, QHostAddress.SpecialAddress],
    ) -> None: ...
...
class QNetworkProxy(PyQt6.sip.simplewrapper):
    ...
    def rawHeader(
        self, headerName: QtCore.QByteArray
    ) -> QtCore.QByteArray: ...
...
class QNetworkReply(QtCore.QIODevice):
    ...
    @typing.overload
    def ignoreSslErrors(
        self, errors: typing.Iterable["QSslError"]
    ) -> None: ...
...
class QNetworkRequest(PyQt6.sip.simplewrapper):
    ...
    class RedirectPolicy(enum.Enum):
        ...
        UserVerifiedRedirectPolicy = (
            ...
        )  # type: QNetworkRequest.RedirectPolicy
...
class QSslCertificate(PyQt6.sip.simplewrapper):
    ...
    def importPkcs12(
        ...
        caCertificates: typing.Optional[
            typing.Iterable["QSslCertificate"]
        ] = ...,
    ...
    @typing.overload
    def subjectInfo(
        self, info: "QSslCertificate.SubjectInfo"
    ) -> typing.List[str]: ...
    @typing.overload
    def subjectInfo(
        self, attribute: QtCore.QByteArray
    ) -> typing.List[str]: ...
    @typing.overload
    def issuerInfo(
        self, info: "QSslCertificate.SubjectInfo"
...
class QSslConfiguration(PyQt6.sip.simplewrapper):
    ...
    def setBackendConfiguration(
        self,
        backendConfiguration: typing.Dict[QtCore.QByteArray, typing.Any] = ...,
    ) -> None: ...
    def setBackendConfigurationOption(
        self, name: QtCore.QByteArray, value: typing.Any
    ) -> None: ...
    def backendConfiguration(
        self,
    ) -> typing.Dict[QtCore.QByteArray, typing.Any]: ...
...
class QSslKey(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, handle: PyQt6.sip.voidptr, type: QSsl.KeyType = ...
    ) -> None: ...
    @typing.overload
    ...
    def handle(self) -> PyQt6.sip.voidptr: ...
    def toDer(
        self, passPhrase: QtCore.QByteArray = ...
    ) -> QtCore.QByteArray: ...
    def toPem(
        self, passPhrase: QtCore.QByteArray = ...
    ) -> QtCore.QByteArray: ...
...
class QUdpSocket(QAbstractSocket):
    ...
    def readDatagram(
        self, maxlen: int
    ) -> typing.Tuple[bytes, QHostAddress, int]: ...
