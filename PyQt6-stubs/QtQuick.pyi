...
class QQuickItem(QtCore.QObject, QtQml.QQmlParserStatus):
    ...
    def __init__(
        self, parent: typing.Optional["QQuickItem"] = ...
    ) -> None: ...
    ...
    def childMouseEventFilter(
        self, a0: "QQuickItem", a1: QtCore.QEvent
    ) -> bool: ...
    ...
    def updateInputMethod(
        self, queries: QtCore.Qt.InputMethodQueries = ...
    ) -> None: ...
    def itemChange(
    ...
    def mapFromItem(
        self, item: "QQuickItem", point: QtCore.QPointF
    ) -> QtCore.QPointF: ...
    ...
    def setFlag(
        self, flag: "QQuickItem.Flags", enabled: bool = ...
    ) -> None: ...
...
class QQuickImageProvider(QtQml.QQmlImageProviderBase):
    def __init__(
        ...
        flags: QtQml.QQmlImageProviderBase.Flags = ...,
    ) -> None: ...
    def requestTexture(
...
class QQuickPaintedItem(QQuickItem):
    ...
    class RenderTarget(enum.Enum):
        ...
        InvertedYFramebufferObject = (
            ...
        )  # type: QQuickPaintedItem.RenderTarget
    def __init__(self, parent: typing.Optional[QQuickItem] = ...) -> None: ...
    ...
    def setPerformanceHints(
        self, hints: "QQuickPaintedItem.PerformanceHints"
    ) -> None: ...
    def setPerformanceHint(
        self, hint: "QQuickPaintedItem.PerformanceHints", enabled: bool = ...
    ) -> None: ...
...
class QQuickWindow(QtGui.QWindow):
    ...
    def __init__(
        self, parent: typing.Optional[QtGui.QWindow] = ...
    ) -> None: ...
    ...
    def setTextRenderType(
        renderType: "QQuickWindow.TextRenderType",
    ) -> None: ...
    @staticmethod
    ...
    def createTextureFromImage(
        self, image: QtGui.QImage, options: "QQuickWindow.CreateTextureOptions"
    ) -> "QSGTexture": ...
...
class QQuickView(QQuickWindow):
    ...
    @typing.overload
    def __init__(
        self, engine: QtQml.QQmlEngine, parent: QtGui.QWindow
    ) -> None: ...
    @typing.overload
    def __init__(
...
class QSGMaterial(PyQt6.sip.wrapper):
    ...
    def __init__(self) -> None: ...
    def setFlag(
        self, flags: "QSGMaterial.Flags", enabled: bool = ...
    ) -> None: ...
...
class QSGGeometry(PyQt6.sip.wrapper):
    ...
    def updateColoredRectGeometry(
        g: "QSGGeometry", rect: QtCore.QRectF
    ) -> None: ...
...
class QSGNode(PyQt6.sip.wrapper):
    ...
    def insertChildNodeAfter(
        self, node: "QSGNode", after: "QSGNode"
    ) -> None: ...
    def insertChildNodeBefore(
        self, node: "QSGNode", before: "QSGNode"
    ) -> None: ...
...
class QSGImageNode(QSGGeometryNode):
    class TextureCoordinatesTransformMode(enum.Flag):
        ...
        MirrorHorizontally = (
            ...
        )  # type: QSGImageNode.TextureCoordinatesTransformMode
        MirrorVertically = (
            ...
        )  # type: QSGImageNode.TextureCoordinatesTransformMode
    ...
    def rebuildGeometry(
        ...
        texCoordMode: "QSGImageNode.TextureCoordinatesTransformMode",
    ) -> None: ...
    ...
    def setTextureCoordinatesTransform(
        self, mode: "QSGImageNode.TextureCoordinatesTransformMode"
    ) -> None: ...
    def mipmapFiltering(self) -> "QSGTexture.Filtering": ...
    def setMipmapFiltering(
        self, filtering: "QSGTexture.Filtering"
    ) -> None: ...
...
class QSGMaterialShader(PyQt6.sip.simplewrapper):
    ...
    class RenderState(PyQt6.sip.simplewrapper):
        class DirtyStates(enum.Flag):
            DirtyMatrix = (
                ...
            )  # type: QSGMaterialShader.RenderState.DirtyStates
            DirtyOpacity = (
                ...
            )  # type: QSGMaterialShader.RenderState.DirtyStates
    ...
    class GraphicsPipelineState(PyQt6.sip.simplewrapper):
        class CullMode(enum.Enum):
            CullNone = (
                ...
            )  # type: QSGMaterialShader.GraphicsPipelineState.CullMode
            CullFront = (
                ...
            )  # type: QSGMaterialShader.GraphicsPipelineState.CullMode
            CullBack = (
    ...
    def setFlag(
        self, flags: "QSGMaterialShader.Flags", on: bool = ...
    ) -> None: ...
...
class QSGRendererInterface(PyQt6.sip.simplewrapper):
    ...
    class ShaderCompilationTypes(enum.Flag):
        RuntimeCompilation = (
            ...
        )  # type: QSGRendererInterface.ShaderCompilationTypes
        OfflineCompilation = (
            ...
        )  # type: QSGRendererInterface.ShaderCompilationTypes
    ...
    @typing.overload
    def getResource(
        self, window: QQuickWindow, resource: str
    ) -> PyQt6.sip.voidptr: ...
...
class QSGSimpleTextureNode(QSGGeometryNode):
    class TextureCoordinatesTransformMode(enum.Flag):
        NoTransform = (
            ...
        )  # type: QSGSimpleTextureNode.TextureCoordinatesTransformMode
        MirrorHorizontally = (
            ...
        )  # type: QSGSimpleTextureNode.TextureCoordinatesTransformMode
        MirrorVertically = (
    ...
    def setTextureCoordinatesTransform(
        self, mode: "QSGSimpleTextureNode.TextureCoordinatesTransformMode"
    ) -> None: ...
    def filtering(self) -> "QSGTexture.Filtering": ...
    def setFiltering(self, filtering: "QSGTexture.Filtering") -> None: ...
    def texture(self) -> "QSGTexture": ...
...
class QNativeInterface(PyQt6.sip.simplewrapper):
    class QSGOpenGLTexture(PyQt6.sip.simplewrapper):
        ...
        def fromNative(
            ...
            window: QQuickWindow,
            size: QtCore.QSize,
            options: QQuickWindow.CreateTextureOptions = ...,
        ) -> QSGTexture: ...
