...
class QAbstractFileIconProvider(PyQt6.sip.simplewrapper):
    class Options(enum.Flag):
        DontUseCustomDirectoryIcons = (
            ...
        )  # type: QAbstractFileIconProvider.Options
...
class QAbstractTextDocumentLayout(QtCore.QObject):
    ...
    def registerHandler(
        self, objectType: int, component: QtCore.QObject
    ) -> None: ...
...
class QAction(QtCore.QObject):
    ...
    def showStatusText(
        self, object: typing.Optional[QtCore.QObject] = ...
    ) -> bool: ...
...
class QPixmap(QPaintDevice):
    ...
    @typing.overload
    def copy(
        self, ax: int, ay: int, awidth: int, aheight: int
    ) -> "QPixmap": ...
    @typing.overload
    def save(
        self,
    ...
    def convertFromImage(
        self, img: "QImage", flags: QtCore.Qt.ImageConversionFlags = ...
    ) -> bool: ...
    @staticmethod
    def fromImageReader(
    ...
    @staticmethod
    def fromImage(
        image: "QImage", flags: QtCore.Qt.ImageConversionFlags = ...
    ) -> "QPixmap": ...
...
class QBitmap(QPixmap):
    ...
    @typing.overload
    def __init__(
        self, fileName: str, format: typing.Optional[str] = ...
    ) -> None: ...
    @typing.overload
    def __init__(self, variant: typing.Any) -> None: ...
    @typing.overload
...
class QColorConstants(PyQt6.sip.simplewrapper):
    class Svg(PyQt6.sip.simplewrapper):
        ...
        blanchedalmond = (
            ...
        )  # type: typing.Union[QColor, QtCore.Qt.GlobalColor]
...
class QBrush(PyQt6.sip.simplewrapper):
    ...
    def __init__(
        self,
        brush: typing.Union[
            "QBrush", QColor, QtCore.Qt.GlobalColor, "QGradient"
        ],
    ) -> None: ...
    @typing.overload
    def __init__(self, variant: typing.Any) -> None: ...
...
class QClipboard(QtCore.QObject):
    ...
    changed: typing.ClassVar[QtCore.pyqtSignal]
    def setPixmap(
        self, a0: QPixmap, mode: "QClipboard.Mode" = ...
    ) -> None: ...
    def setImage(
        self, a0: "QImage", mode: "QClipboard.Mode" = ...
    ) -> None: ...
...
class QCursor(PyQt6.sip.simplewrapper):
    ...
    def __init__(self, variant: typing.Any) -> None: ...
    def swap(
        self, other: typing.Union["QCursor", QtCore.Qt.CursorShape]
    ) -> None: ...
    @typing.overload
    @staticmethod
...
class QDesktopServices(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def setUrlHandler(
        scheme: str, receiver: QtCore.QObject, method: str
    ) -> None: ...
    @typing.overload
    @staticmethod
    def setUrlHandler(
...
class QDrag(QtCore.QObject):
    ...
    def setDragCursor(
        self, cursor: QPixmap, action: QtCore.Qt.DropActions
    ) -> None: ...
    ...
    @typing.overload
    def exec(
        self, supportedActions: QtCore.Qt.DropActions = ...
    ) -> QtCore.Qt.DropActions: ...
    @typing.overload
    def exec(
        self,
        supportedActions: QtCore.Qt.DropActions,
        defaultDropAction: QtCore.Qt.DropActions,
    ) -> QtCore.Qt.DropActions: ...
...
class QInputMethodQueryEvent(QtCore.QEvent):
    ...
    def setValue(
        self, query: QtCore.Qt.InputMethodQueries, value: typing.Any
    ) -> None: ...
...
class QFileOpenEvent(QtCore.QEvent):
    ...
    def openFile(
        self, file: QtCore.QFile, flags: QtCore.QIODeviceBase.OpenMode
    ) -> bool: ...
...
class QPlatformSurfaceEvent(QtCore.QEvent):
    class SurfaceEventType(enum.Enum):
        ...
        SurfaceAboutToBeDestroyed = (
            ...
        )  # type: QPlatformSurfaceEvent.SurfaceEventType
    def __init__(
...
class QSinglePointEvent(QPointerEvent):
    ...
    def setExclusivePointGrabber(
        self, exclusiveGrabber: QtCore.QObject
    ) -> None: ...
...
class QTabletEvent(QSinglePointEvent):
    def __init__(
        ...
        rotation: float,
        z: float,
        keyState: QtCore.Qt.KeyboardModifiers,
        button: QtCore.Qt.MouseButtons,
        buttons: QtCore.Qt.MouseButtons,
    ) -> None: ...
...
class QFileSystemModel(QtCore.QAbstractItemModel):
    ...
    def setOption(
        self, option: "QFileSystemModel.Options", on: bool = ...
    ) -> None: ...
    def sibling(
    ...
    def mkdir(
        self, parent: QtCore.QModelIndex, name: str
    ) -> QtCore.QModelIndex: ...
...
class QGlyphRun(PyQt6.sip.simplewrapper):
    ...
    def setFlag(
        self, flag: "QGlyphRun.GlyphRunFlags", enabled: bool = ...
    ) -> None: ...
    ...
    def clear(self) -> None: ...
    def setPositions(
        self, positions: typing.Iterable[QtCore.QPointF]
    ) -> None: ...
...
class QImage(QPaintDevice):
    ...
    @typing.overload
    def __init__(
        self, size: QtCore.QSize, format: "QImage.Format"
    ) -> None: ...
    @typing.overload
    def __init__(
    ...
    def convertTo(
        self, f: "QImage.Format", flags: QtCore.Qt.ImageConversionFlags = ...
    ) -> None: ...
    def convertedTo(
        self, f: "QImage.Format", flags: QtCore.Qt.ImageConversionFlags = ...
    ) -> "QImage": ...
    ...
    @staticmethod
    def fromData(
        data: bytes, format: typing.Optional[str] = ...
    ) -> "QImage": ...
    @typing.overload
    @staticmethod
    def fromData(
    ...
    @typing.overload
    def loadFromData(
        self, data: bytes, format: typing.Optional[str] = ...
    ) -> bool: ...
    @typing.overload
    def loadFromData(
    ...
    def createAlphaMask(
        self, flags: QtCore.Qt.ImageConversionFlags = ...
    ) -> "QImage": ...
...
class QImageIOHandler(PyQt6.sip.simplewrapper):
    class Transformations(enum.Flag):
        ...
        TransformationMirrorAndRotate90 = (
            ...
        )  # type: QImageIOHandler.Transformations
    ...
    def supportsOption(
        self, option: "QImageIOHandler.ImageOption"
    ) -> bool: ...
    def setOption(
...
class QImageReader(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, fileName: str, format: QtCore.QByteArray = ...
    ) -> None: ...
    @staticmethod
...
class QImageWriter(PyQt6.sip.simplewrapper):
    ...
    def setTransformation(
        self, orientation: QImageIOHandler.Transformations
    ) -> None: ...
    def transformation(self) -> QImageIOHandler.Transformations: ...
...
class QInputMethod(QtCore.QObject):
    ...
    def queryFocusObject(
        query: QtCore.Qt.InputMethodQueries, argument: typing.Any
    ) -> typing.Any: ...
...
class QOpenGLContext(QtCore.QObject):
    ...
    @staticmethod
    def areSharing(
        first: "QOpenGLContext", second: "QOpenGLContext"
    ) -> bool: ...
    @staticmethod
    def currentContext() -> "QOpenGLContext": ...
    def surface(self) -> QSurface: ...
    def getProcAddress(
        self, procName: QtCore.QByteArray
    ) -> PyQt6.sip.voidptr: ...
...
class QWindow(QtCore.QObject, QSurface):
    ...
    def setCursor(
        self, a0: typing.Union[QCursor, QtCore.Qt.CursorShape]
    ) -> None: ...
    ...
    def reportContentOrientationChange(
        self, orientation: QtCore.Qt.ScreenOrientations
    ) -> None: ...
...
class QPaintEngine(PyQt6.sip.simplewrapper):
    ...
    class PaintEngineFeatures(enum.Flag):
        ...
        ObjectBoundingModeGradients = (
            ...
        )  # type: QPaintEngine.PaintEngineFeatures
        RasterOpModes = ...  # type: QPaintEngine.PaintEngineFeatures
        AllFeatures = ...  # type: QPaintEngine.PaintEngineFeatures
    def __init__(
        self, features: "QPaintEngine.PaintEngineFeatures" = ...
    ) -> None: ...
    def hasFeature(
        self, feature: "QPaintEngine.PaintEngineFeatures"
    ) -> bool: ...
...
class QPainter(PyQt6.sip.simplewrapper):
    ...
    def paintEngine(self) -> QPaintEngine: ...
    def setRenderHints(
        self, hints: "QPainter.RenderHints", on: bool = ...
    ) -> None: ...
    def renderHints(self) -> "QPainter.RenderHints": ...
    def setRenderHint(
        self, hint: "QPainter.RenderHints", on: bool = ...
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def drawRects(
        self, rectangles: typing.Iterable[QtCore.QRectF]
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def drawLines(
        self, pointPairs: typing.Iterable[QtCore.QPointF]
    ) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def drawLines(
        self, pointPairs: typing.Iterable[QtCore.QPoint]
    ) -> None: ...
    @typing.overload
    ...
    def setBackground(
        self,
        bg: typing.Union[QBrush, QColor, QtCore.Qt.GlobalColor, QGradient],
    ) -> None: ...
    @typing.overload
...
class QPdfWriter(QtCore.QObject, QPagedPaintDevice):
    ...
    def setDocumentXmpMetadata(
        self, xmpMetadata: QtCore.QByteArray
    ) -> None: ...
...
class QPointingDevice(QInputDevice):
    ...
    def __init__(
        ...
        name: str,
        systemId: int,
        devType: QInputDevice.DeviceTypes,
        pType: "QPointingDevice.PointerTypes",
        caps: QInputDevice.Capabilities,
        maxPoints: int,
        buttonCount: int,
        seatName: str = ...,
...
class QQuaternion(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def fromDirection(
        direction: "QVector3D", up: "QVector3D"
    ) -> "QQuaternion": ...
    @staticmethod
    def fromAxes(
    ...
    def getAxes(
        self,
    ) -> typing.Tuple["QVector3D", "QVector3D", "QVector3D"]: ...
    @staticmethod
    ...
    @staticmethod
    def nlerp(
        q1: "QQuaternion", q2: "QQuaternion", t: float
    ) -> "QQuaternion": ...
    @staticmethod
    def slerp(
        q1: "QQuaternion", q2: "QQuaternion", t: float
...
class QRawFont(PyQt6.sip.simplewrapper):
    ...
    def advancesForGlyphIndexes(
        ...
        layoutFlags: "QRawFont.LayoutFlags",
...
class QScreen(QtCore.QObject):
    ...
    def mapBetween(
        self,
        a: QtCore.Qt.ScreenOrientations,
        b: QtCore.Qt.ScreenOrientations,
        rect: QtCore.QRect,
    ) -> QtCore.QRect: ...
    ...
    def angleBetween(
        self, a: QtCore.Qt.ScreenOrientations, b: QtCore.Qt.ScreenOrientations
    ) -> int: ...
...
class QSessionManager(QtCore.QObject):
    ...
    def setManagerProperty(
        self, name: str, value: typing.Iterable[str]
    ) -> None: ...
...
class QStandardItemModel(QtCore.QAbstractItemModel):
    ...
    def setItemRoleNames(
        self, roleNames: typing.Dict[int, QtCore.QByteArray]
    ) -> None: ...
    def dropMimeData(
        self,
        data: QtCore.QMimeData,
    ...
    @typing.overload
    def insertRow(
        self, row: int, items: typing.Iterable["QStandardItem"]
    ) -> None: ...
    @typing.overload
    ...
    def appendColumn(
        self, items: typing.Iterable["QStandardItem"]
    ) -> None: ...
    @typing.overload
...
class QStandardItem(PyQt6.sip.wrapper):
    ...
    def setAccessibleDescription(
        self, aaccessibleDescription: str
    ) -> None: ...
    ...
    def setTextAlignment(
        self, atextAlignment: QtCore.Qt.Alignment
    ) -> None: ...
...
class QStaticText(PyQt6.sip.simplewrapper):
    ...
    def prepare(
        self, matrix: "QTransform" = ..., font: QFont = ...
    ) -> None: ...
...
class QSurfaceFormat(PyQt6.sip.simplewrapper):
    ...
    def setOption(
        self, option: "QSurfaceFormat.FormatOptions", on: bool = ...
    ) -> None: ...
...
class QTextCursor(PyQt6.sip.simplewrapper):
    ...
    def insertImage(
        ...
        alignment: "QTextFrameFormat.Position",
    ) -> None: ...
    @typing.overload
...
class QTextDocument(QtCore.QObject):
    ...
    def setMarkdown(
        self, markdown: str, features: "QTextDocument.MarkdownFeatures" = ...
    ) -> None: ...
    def toMarkdown(
        self, features: "QTextDocument.MarkdownFeatures" = ...
    ) -> str: ...
    ...
    def toHtml(self) -> str: ...
    def metaInformation(
        self, info: "QTextDocument.MetaInformation"
    ) -> str: ...
    ...
    def setDocumentLayout(
        self, layout: QAbstractTextDocumentLayout
    ) -> None: ...
...
class QTextBlockFormat(QTextFormat):
    ...
    def setTabPositions(
        self, tabs: typing.Iterable["QTextOption.Tab"]
    ) -> None: ...
...
class QTextLayout(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def drawCursor(
        self, p: QPainter, pos: QtCore.QPointF, cursorPosition: int
    ) -> None: ...
    @typing.overload
    def drawCursor(
...
class QTextOption(PyQt6.sip.simplewrapper):
    ...
    def setTabs(
        self, tabStops: typing.Iterable["QTextOption.Tab"]
    ) -> None: ...
...
class QUndoGroup(QtCore.QObject):
    ...
    def createUndoAction(
        self, parent: QtCore.QObject, prefix: str = ...
    ) -> QAction: ...
...
class QUndoCommand(PyQt6.sip.wrapper):
    @typing.overload
    def __init__(
        self, parent: typing.Optional["QUndoCommand"] = ...
    ) -> None: ...
    @typing.overload
    def __init__(
...
class QVector3D(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def normal(
        v1: "QVector3D", v2: "QVector3D", v3: "QVector3D"
    ) -> "QVector3D": ...
    @staticmethod
