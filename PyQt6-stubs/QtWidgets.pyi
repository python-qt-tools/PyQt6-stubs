...
class QStyle(QtCore.QObject):
    ...
    def layoutSpacing(self, control1: "QSizePolicy.ControlTypes", control2: "QSizePolicy.ControlTypes", orientation: QtCore.Qt.Orientation, option: typing.Optional["QStyleOption"] = ..., widget: typing.Optional[QWidget] = ...) -> int: ...
    @staticmethod
...
class QDialogButtonBox(QWidget):
    ...
    def setStandardButton(self, buttons: "QDialogButtonBox.StandardButton") -> None: ...
...
class QGraphicsItem(PyQt6.sip.wrapper):
    ...
    class GraphicsItemChange(enum.Enum):
        ...
        ItemFlagChange = ...  # type: QGraphicsItem.GraphicsItemChange
        ItemFlagHaveChanged = ...  # type: QGraphicsItem.GraphicsItemChange
...
class QGraphicsProxyWidget(QGraphicsWidget):
    ...
    def type(self) -> int: ...
    def paint(self, painter: QtGui.QPainter, option: "QStyleOptionGraphicsItem", widget: QWidget) -> None: ...  # type: ignore[override]  # type: ignore[override]
...
class QMessageBox(QDialog):
    ...
    def __init__(self, parent: typing.Optional[QWidget] = ...) -> None: ...
    @typing.overload
    def __init__(self, icon: "QMessageBox.Icon", title: str, text: str, buttons: "QMessageBox.StandardButton" = ..., parent: typing.Optional[QWidget] = ..., flags: QtCore.Qt.WindowFlags = ...) -> None: ...
    ...
    def setStandardButton(self, buttons: "QMessageBox.StandardButton") -> None: ...
    def removeButton(self, button: QAbstractButton) -> None: ...
    @typing.overload
...
class QProxyStyle(QCommonStyle):
    ...
    @typing.overload  # type: ignore[override]  # type: ignore[override]
    def polish(self, widget: QWidget) -> None: ...
    @typing.overload
    ...
    def standardPalette(self) -> QtGui.QPalette: ...
    def generatedIconPixmap(self, iconMode: QtGui.QIcon.Mode, pixmap: QtGui.QPixmap, opt: "QStyleOption") -> QtGui.QPixmap: ...
    def standardPixmap(self, standardPixmap: QStyle.StandardPixmap, opt: "QStyleOption", widget: typing.Optional[QWidget] = ...) -> QtGui.QPixmap: ...  # type: ignore[override]  # type: ignore[override]
    def standardIcon(self, standardIcon: QStyle.StandardPixmap, option: typing.Optional["QStyleOption"] = ..., widget: typing.Optional[QWidget] = ...) -> QtGui.QIcon: ...
    def layoutSpacing(self, control1: "QSizePolicy.ControlTypes", control2: "QSizePolicy.ControlTypes", orientation: QtCore.Qt.Orientation, option: typing.Optional["QStyleOption"] = ..., widget: typing.Optional[QWidget] = ...) -> int: ...
    def pixelMetric(self, metric: QStyle.PixelMetric, option: typing.Optional["QStyleOption"] = ..., widget: typing.Optional[QWidget] = ...) -> int: ...
    ...
    def itemPixmapRect(self, r: QtCore.QRect, flags: int, pixmap: QtGui.QPixmap) -> QtCore.QRect: ...
    def itemTextRect(self, fm: QtGui.QFontMetrics, r: QtCore.QRect, flags: int, enabled: bool, text: str) -> QtCore.QRect: ...
    def subControlRect(self, cc: QStyle.ComplexControl, opt: "QStyleOptionComplex", sc: QStyle.SubControls, widget: QWidget) -> QtCore.QRect: ...  # type: ignore[override]  # type: ignore[override]
    def subElementRect(self, element: QStyle.SubElement, option: "QStyleOption", widget: QWidget) -> QtCore.QRect: ...  # type: ignore[override]  # type: ignore[override]
    def sizeFromContents(self, type: QStyle.ContentsType, option: "QStyleOption", size: QtCore.QSize, widget: QWidget) -> QtCore.QSize: ...  # type: ignore[override]  # type: ignore[override]
    def drawItemPixmap(self, painter: QtGui.QPainter, rect: QtCore.QRect, alignment: int, pixmap: QtGui.QPixmap) -> None: ...
