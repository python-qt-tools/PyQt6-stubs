...
class QDomElement(QDomNode):
    ...
    @typing.overload
    def setAttributeNS(self, nsURI: str, qName: str, value: int) -> None: ...  # type: ignore[misc]
    ...
    @typing.overload
    def setAttribute(self, name: str, value: int) -> None: ...  # type: ignore[misc]
    @typing.overload
    def setAttribute(self, name: str, value: float) -> None: ...
    @typing.overload
    def setAttribute(self, name: str, value: int) -> None: ...  # type: ignore[misc]  # type: ignore[misc]  # type: ignore[misc]
