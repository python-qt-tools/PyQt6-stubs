...
class QDesignerActionEditorInterface(QtWidgets.QWidget):
    def __init__(
        self, parent: QtWidgets.QWidget, flags: QtCore.Qt.WindowFlags = ...
    ) -> None: ...
    def setFormWindow(
...
class QAbstractFormBuilder(PyQt6.sip.simplewrapper):
    ...
    def save(
        self, dev: QtCore.QIODevice, widget: QtWidgets.QWidget
    ) -> None: ...
    def load(
        self,
...
class QDesignerFormEditorInterface(QtCore.QObject):
    ...
    def setActionEditor(
        self, actionEditor: QDesignerActionEditorInterface
    ) -> None: ...
    ...
    def setWidgetBox(
        self, widgetBox: "QDesignerWidgetBoxInterface"
    ) -> None: ...
...
class QDesignerFormWindowInterface(QtWidgets.QWidget):
    ...
    def selectWidget(
        self, widget: QtWidgets.QWidget, select: bool = ...
    ) -> None: ...
    def clearSelection(self, update: bool = ...) -> None: ...
    def setDirty(self, dirty: bool) -> None: ...
    def setFeatures(
        self, f: "QDesignerFormWindowInterface.Feature"
    ) -> None: ...
...
class QAbstractExtensionFactory(PyQt6.sip.simplewrapper):
    ...
    def extension(
        self, object: QtCore.QObject, iid: str
    ) -> QtCore.QObject: ...

class QExtensionFactory(QtCore.QObject, QAbstractExtensionFactory):
    def __init__(
        self, parent: typing.Optional["QExtensionManager"] = ...
    ) -> None: ...
    def createExtension(
