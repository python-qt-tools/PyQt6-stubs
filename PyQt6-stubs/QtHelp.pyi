...
class QHelpEngineCore(QtCore.QObject):
    ...
    def customValue(
        self, key: str, defaultValue: typing.Any = ...
    ) -> typing.Any: ...
...
class QHelpFilterEngine(QtCore.QObject):
    ...
    def setFilterData(
        self, filterName: str, filterData: QHelpFilterData
    ) -> bool: ...
    ...
    def namespaceToVersion(
        self,
    ) -> typing.Dict[str, QtCore.QVersionNumber]: ...
...
class QHelpFilterSettingsWidget(QtWidgets.QWidget):
    ...
    def setAvailableComponents(
        self, components: typing.Iterable[str]
    ) -> None: ...
