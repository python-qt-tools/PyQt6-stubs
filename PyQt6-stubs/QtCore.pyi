...
class QKeyCombination(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, modifiers: Qt.KeyboardModifiers, key: Qt.Key = ...
    ) -> None: ...
    @typing.overload
...
class QObject(PyQt6.sip.wrapper):
    ...
    objectNameChanged: typing.ClassVar[QtCore.pyqtSignal]
...
class QAbstractEventDispatcher(QObject):
    class TimerInfo(PyQt6.sip.simplewrapper):
        ...
        @typing.overload
        def __init__(
            self, a0: "QAbstractEventDispatcher.TimerInfo"
        ) -> None: ...
    def __init__(self, parent: typing.Optional[QObject] = ...) -> None: ...
...
class QAbstractItemModel(QObject):
    ...
    def changePersistentIndexList(
        self,
        from_: typing.Iterable[QModelIndex],
        to: typing.Iterable[QModelIndex],
    ) -> None: ...
    ...
    def headerData(
        self, section: int, orientation: Qt.Orientations, role: int = ...
    ) -> typing.Any: ...
    def setData(
...
class QAnimationGroup(QAbstractAnimation):
    ...
    def insertAnimation(
        self, index: int, animation: QAbstractAnimation
    ) -> None: ...
...
class QBasicTimer(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def start(
        self, msec: int, timerType: Qt.TimerType, obj: QObject
    ) -> None: ...
    @typing.overload
...
class QByteArray(PyQt6.sip.simplewrapper):
    ...
    def fromBase64Encoding(
        base64: "QByteArray", options: "QByteArray.Base64Options" = ...
    ...
    def toBase64(
        self, options: "QByteArray.Base64Options" = ...
    ) -> "QByteArray": ...
...
class QCborStreamReader(PyQt6.sip.simplewrapper):
    ...
    def readString(
        self,
    ) -> typing.Tuple[str, "QCborStreamReader.StringResultCode"]: ...
...
class QCommandLineOption(PyQt6.sip.simplewrapper):
    ...
    def setDefaultValues(
        self, defaultValues: typing.Iterable[str]
    ) -> None: ...
...
class QCommandLineParser(PyQt6.sip.simplewrapper):
    ...
    def addOptions(
        self, options: typing.Iterable[QCommandLineOption]
    ) -> bool: ...
...
class QCoreApplication(QObject):
    ...
    def event(self, a0: "QEvent") -> bool: ...
    aboutToQuit: typing.ClassVar[QtCore.pyqtSignal]
    @staticmethod
    def quit() -> None: ...
    @staticmethod
    ...
    def removePostedEvents(
        receiver: QObject, eventType: int = ...
    ) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def postEvent(
        receiver: QObject, event: "QEvent", priority: int = ...
    ) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def processEvents(
        flags: "QEventLoop.ProcessEventFlags", maxtime: int
    ) -> None: ...
    @staticmethod
    def exec() -> int: ...
    @staticmethod
...
class QCryptographicHash(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def hash(
        data: QByteArray, method: "QCryptographicHash.Algorithm"
    ) -> QByteArray: ...
...
class QDate(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def fromString(
        string: str, format: str, cal: QCalendar = ...
    ) -> "QDate": ...
    @staticmethod
...
class QDateTime(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, other: typing.Union["QDateTime", datetime.datetime]
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
    ...
    @staticmethod
    def fromString(
        string: str, format: Qt.DateFormat = ...
    ) -> "QDateTime": ...
    @typing.overload
    @staticmethod
    def fromString(
...
class QDir(PyQt6.sip.simplewrapper):
    ...
    @staticmethod
    def setSearchPaths(
        prefix: str, searchPaths: typing.Iterable[str]
    ) -> None: ...
    @staticmethod
...
class QEventLoop(QObject):
    ...
    @typing.overload
    def processEvents(
        self, flags: "QEventLoop.ProcessEventFlags" = ...
    ) -> bool: ...
    @typing.overload
    def processEvents(
        self, flags: "QEventLoop.ProcessEventFlags", maximumTime: int
    ) -> None: ...
...
class QFileDevice(QIODevice):
    ...
    def setPermissions(
        self, permissionSpec: "QFileDevice.Permissions"
    ) -> bool: ...
...
class QFile(QFileDevice):
    ...
    @staticmethod
    def setPermissions(
        filename: str, permissionSpec: QFileDevice.Permissions
    ) -> bool: ...
    @typing.overload
    def permissions(self) -> QFileDevice.Permissions: ...
    @typing.overload
...
class QItemSelectionModel(QObject):
    ...
    @typing.overload
    def __init__(
        self, model: typing.Optional[QAbstractItemModel] = ...
    ) -> None: ...
    @typing.overload
    ...
    def setCurrentIndex(
        self, index: QModelIndex, command: "QItemSelectionModel.SelectionFlags"
    ) -> None: ...
    @typing.overload
    def select(
        self, index: QModelIndex, command: "QItemSelectionModel.SelectionFlags"
...
class QJsonDocument(PyQt6.sip.simplewrapper):
    ...
    def isEmpty(self) -> bool: ...
    def toJson(
        self, format: "QJsonDocument.JsonFormat" = ...
    ) -> QByteArray: ...
    @staticmethod
    def fromJson(
...
class QLibrary(QObject):
    ...
    @staticmethod
    def resolve(
        fileName: str, verNum: int, symbol: str
    ) -> PyQt6.sip.voidptr: ...
    @typing.overload
    @staticmethod
    def resolve(
        fileName: str, version: str, symbol: str
    ) -> PyQt6.sip.voidptr: ...
...
class QLocale(PyQt6.sip.simplewrapper):
    ...
    class FloatingPointPrecisionOption(enum.Enum):
        FloatingPointShortest = (
            ...
        )  # type: QLocale.FloatingPointPrecisionOption
    ...
    def formattedDataSize(
        ...
        bytes: int,
        precision: int = ...,
        format: "QLocale.DataSizeFormats" = ...,
    ) -> str: ...
    ...
    @typing.overload
    def toDateTime(
        self, string: str, format: str, cal: QCalendar
    ) -> QDateTime: ...
    @typing.overload
    def toTime(
        self, string: str, format: "QLocale.FormatType" = ...
...
class QMessageLogger(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, file: str, line: int, function: str, category: str
    ) -> None: ...
...
class QLoggingCategory(PyQt6.sip.simplewrapper):
    def __init__(
        self, category: str, severityLevel: QtMsgType = ...
    ) -> None: ...
    @staticmethod
...
class QMimeData(QObject):
    def __init__(self) -> None: ...
    def retrieveData(
        self, mimetype: str, preferredType: QMetaType
    ) -> typing.Any: ...
...
class QPauseAnimation(QAbstractAnimation):
    ...
    @typing.overload
    def __init__(
        self, msecs: int, parent: typing.Optional[QObject] = ...
    ) -> None: ...
...
class QProcess(QIODevice):
    ...
    def setInputChannelMode(
        self, mode: "QProcess.InputChannelMode"
    ) -> None: ...
    ...
    readyReadStandardError: typing.ClassVar[QtCore.pyqtSignal]
    readyReadStandardOutput: typing.ClassVar[QtCore.pyqtSignal]
    stateChanged: typing.ClassVar[QtCore.pyqtSignal]
    finished: typing.ClassVar[QtCore.pyqtSignal]
    ...
    def setStandardErrorFile(
        self, fileName: str, mode: QIODeviceBase.OpenMode = ...
    ) -> None: ...
    ...
    @staticmethod
    def execute(
        program: str, arguments: typing.Iterable[str] = ...
    ) -> int: ...
    def close(self) -> None: ...
    def isSequential(self) -> bool: ...
    def bytesToWrite(self) -> int: ...
    ...
    def startCommand(
        self, command: str, mode: QIODeviceBase.OpenMode = ...
    ) -> None: ...
    @typing.overload
    def start(
        self,
...
class QRegularExpression(PyQt6.sip.simplewrapper):
    class WildcardConversionOptions(enum.Flag):
        DefaultWildcardConversion = (
            ...
        )  # type: QRegularExpression.WildcardConversionOptions
    ...
    class MatchOptions(enum.Flag):
        ...
        AnchorAtOffsetMatchOption = (
            ...
        )  # type: QRegularExpression.MatchOptions
    ...
    class PatternOptions(enum.Flag):
        ...
        DotMatchesEverythingOption = (
            ...
        )  # type: QRegularExpression.PatternOptions
    ...
    @typing.overload
    def __init__(
        self, pattern: str, options: "QRegularExpression.PatternOptions" = ...
    ) -> None: ...
    @typing.overload
    ...
    def setPatternOptions(
        self, options: "QRegularExpression.PatternOptions"
    ) -> None: ...
...
class QRegularExpressionMatchIterator(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, iterator: "QRegularExpressionMatchIterator"
    ) -> None: ...
    def matchOptions(self) -> QRegularExpression.MatchOptions: ...
    def matchType(self) -> QRegularExpression.MatchType: ...
    def regularExpression(self) -> QRegularExpression: ...
...
class QSharedMemory(QObject):
    ...
    @typing.overload
    def __init__(
        self, key: str, parent: typing.Optional[QObject] = ...
    ) -> None: ...
...
class QSortFilterProxyModel(QAbstractProxyModel):
    def __init__(self, parent: typing.Optional[QObject] = ...) -> None: ...
    autoAcceptChildRowsChanged: typing.ClassVar[QtCore.pyqtSignal]
...
class QStringEncoder(QStringConverter):
    ...
    @typing.overload
    def __init__(
        self, name: str, flags: QStringConverterBase.Flags = ...
    ) -> None: ...
...
class QTextStream(QIODeviceBase):
    ...
    @typing.overload
    def __init__(
        self, array: QByteArray, mode: QIODeviceBase.OpenMode = ...
    ) -> None: ...
...
class QThread(QObject):
    ...
    def setEventDispatcher(
        self, eventDispatcher: QAbstractEventDispatcher
    ) -> None: ...
...
class QTimer(QObject):
    ...
    def timerEvent(self, a0: QTimerEvent) -> None: ...
    timeout: typing.ClassVar[QtCore.pyqtSignal]
    def stop(self) -> None: ...
    @typing.overload
...
class QTimeZone(PyQt6.sip.simplewrapper):
    ...
    def windowsIdToIanaIds(
        windowsId: QByteArray,
    ) -> typing.List[QByteArray]: ...
    @typing.overload
    @staticmethod
    def windowsIdToIanaIds(
        windowsId: QByteArray, country: QLocale.Country
    ) -> typing.List[QByteArray]: ...
    @typing.overload
    @staticmethod
...
class QUrl(PyQt6.sip.simplewrapper):
    ...
    def matches(
        self, url: "QUrl", options: "QUrl.FormattingOptions"
    ) -> bool: ...
    def fileName(
        self, options: "QUrl.ComponentFormattingOptions" = ...
    ) -> str: ...
    ...
    def toDisplayString(
        self, options: "QUrl.FormattingOptions" = ...
    ) -> str: ...
    ...
    def fromUserInput(
        userInput: str,
        workingDirectory: str = ...,
        options: "QUrl.UserInputResolutionOptions" = ...,
    ) -> "QUrl": ...
    @staticmethod
    ...
    @staticmethod
    def fromEncoded(
        u: QByteArray, mode: "QUrl.ParsingMode" = ...
    ) -> "QUrl": ...
    def toEncoded(
        self, options: "QUrl.FormattingOptions" = ...
    ) -> QByteArray: ...
    ...
    def setFragment(
        self, fragment: str, mode: "QUrl.ParsingMode" = ...
    ) -> None: ...
    def path(
        self, options: "QUrl.ComponentFormattingOptions" = ...
    ) -> str: ...
    ...
    def setPassword(
        self, password: str, mode: "QUrl.ParsingMode" = ...
    ) -> None: ...
    def userName(
        self, options: "QUrl.ComponentFormattingOptions" = ...
    ) -> str: ...
    def setUserName(
        self, userName: str, mode: "QUrl.ParsingMode" = ...
    ) -> None: ...
    def userInfo(
        self, options: "QUrl.ComponentFormattingOptions" = ...
    ) -> str: ...
    def setUserInfo(
        self, userInfo: str, mode: "QUrl.ParsingMode" = ...
    ) -> None: ...
    def authority(
        self, options: "QUrl.ComponentFormattingOptions" = ...
    ) -> str: ...
    def setAuthority(
        self, authority: str, mode: "QUrl.ParsingMode" = ...
    ) -> None: ...
    def scheme(self) -> str: ...
...
class QUrlQuery(PyQt6.sip.simplewrapper):
    ...
    def allQueryItemValues(
        self, key: str, options: QUrl.ComponentFormattingOptions = ...
    ) -> typing.List[str]: ...
    def queryItemValue(
        self, key: str, options: QUrl.ComponentFormattingOptions = ...
    ) -> str: ...
    ...
    def setQueryItems(
        self, query: typing.Iterable[typing.Tuple[str, str]]
    ) -> None: ...
...
class QWaitCondition(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def wait(
        self, lockedMutex: QMutex, deadline: QDeadlineTimer = ...
    ) -> bool: ...
    @typing.overload
...
class QXmlStreamReader(PyQt6.sip.simplewrapper):
    ...
    def entityDeclarations(
        self,
    ) -> typing.List[QXmlStreamEntityDeclaration]: ...
    def notationDeclarations(
        self,
    ) -> typing.List[QXmlStreamNotationDeclaration]: ...
    def addExtraNamespaceDeclarations(
        self,
        extraNamespaceDeclaractions: typing.Iterable[
    ...
    def namespaceDeclarations(
        self,
    ) -> typing.List[QXmlStreamNamespaceDeclaration]: ...
    def text(self) -> str: ...
...
class QXmlStreamWriter(PyQt6.sip.simplewrapper):
    ...
    def writeTextElement(
        self, namespaceUri: str, name: str, text: str
    ) -> None: ...
    @typing.overload
    ...
    def writeAttributes(
        self, attributes: typing.Iterable[QXmlStreamAttribute]
    ) -> None: ...
    @typing.overload
    def writeAttribute(self, qualifiedName: str, value: str) -> None: ...
    @typing.overload
    def writeAttribute(
        self, namespaceUri: str, name: str, value: str
    ) -> None: ...
    @typing.overload
...
def qInstallMessageHandler(
    a0: typing.Optional[
        typing.Callable[[QtMsgType, QMessageLogContext, str], None]
    ]
) -> typing.Optional[
    typing.Callable[[QtMsgType, QMessageLogContext, str], None]
]: ...
