...
class QObject(PyQt6.sip.wrapper):
    ...
    @typing.overload
    def findChildren(self, types: typing.Tuple[typing.Type[QObjectT], ...], name: str = ..., options: Qt.FindChildOption = ...) -> typing.List["QObject"]: ...
    @typing.overload
    def findChildren(self, type: type, re: "QRegularExpression", options: Qt.FindChildOption = ...) -> typing.List["QObject"]: ...
    @typing.overload
    def findChildren(self, types: typing.Tuple[typing.Type[QObjectT], ...], re: "QRegularExpression", options: Qt.FindChildOption = ...) -> typing.List["QObject"]: ...
    @typing.overload
    def findChild(self, type: type, name: str = ..., options: Qt.FindChildOption = ...) -> "QObject": ...
    @typing.overload
    def findChild(self, types: typing.Tuple[typing.Type[QObjectT], ...], name: "str" = ..., options: Qt.FindChildOption = ...) -> "QObject": ...
    @staticmethod
...
class QConcatenateTablesProxyModel(QAbstractItemModel):
    ...
    def headerData(self, section: int, orientation: Qt.Orientation, role: int = ...) -> typing.Any: ...
    def rowCount(self, parent: QModelIndex = ...) -> int: ...
    def parent(self, index: QModelIndex) -> QModelIndex: ...  # type: ignore[override]  # type: ignore[override]
    def index(self, row: int, column: int, parent: QModelIndex = ...) -> QModelIndex: ...
    def flags(self, index: QModelIndex) -> Qt.ItemFlag: ...
    def setItemData(self, index: QModelIndex, roles: typing.Dict[int, typing.Any]) -> bool: ...
...
class QIdentityProxyModel(QAbstractProxyModel):
    ...
    def dropMimeData(self, data: "QMimeData", action: Qt.DropAction, row: int, column: int, parent: QModelIndex) -> bool: ...
    def rowCount(self, parent: QModelIndex = ...) -> int: ...
    def parent(self, child: QModelIndex) -> QModelIndex: ...  # type: ignore[override]  # type: ignore[override]
    def mapToSource(self, proxyIndex: QModelIndex) -> QModelIndex: ...
    def mapFromSource(self, sourceIndex: QModelIndex) -> QModelIndex: ...
    def index(self, row: int, column: int, parent: QModelIndex = ...) -> QModelIndex: ...
    def columnCount(self, parent: QModelIndex = ...) -> int: ...
