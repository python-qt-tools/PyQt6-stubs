...
class QSqlDatabase(PyQt6.sip.simplewrapper):
    ...
    def registerSqlDriver(
        name: str, creator: QSqlDriverCreatorBase
    ) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def cloneDatabase(
        other: "QSqlDatabase", connectionName: str
    ) -> "QSqlDatabase": ...
    @typing.overload
    @staticmethod
    ...
    @staticmethod
    def addDatabase(
        driver: "QSqlDriver", connectionName: str = ...
    ) -> "QSqlDatabase": ...
...
class QSqlField(PyQt6.sip.simplewrapper):
    ...
    def setRequiredStatus(
        self, status: "QSqlField.RequiredStatus"
    ) -> None: ...
...
class QSqlQuery(PyQt6.sip.simplewrapper):
    ...
    def addBindValue(
        self, val: typing.Any, type: "QSql.ParamType" = ...
    ) -> None: ...
    @typing.overload
    def bindValue(
        self, placeholder: str, val: typing.Any, type: "QSql.ParamType" = ...
    ) -> None: ...
    @typing.overload
    def bindValue(
        self, pos: int, val: typing.Any, type: "QSql.ParamType" = ...
    ) -> None: ...
    def prepare(self, query: str) -> bool: ...
    def execBatch(
        self, mode: "QSqlQuery.BatchExecutionMode" = ...
    ) -> bool: ...
    def clear(self) -> None: ...
    def last(self) -> bool: ...
    def first(self) -> bool: ...
...
class QSqlRelation(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(
        self, aTableName: str, indexCol: str, displayCol: str
    ) -> None: ...
    @typing.overload
